...
CREATE TABLE `booking` (
  ...
  `pnr_number` varchar(45) DEFAULT NULL,
...
CREATE TABLE `checkin` (
  `id` int NOT NULL AUTO_INCREMENT,
  `check_in_bags` varchar(45) DEFAULT NULL,
  `cabin_bags` varchar(45) DEFAULT NULL,
...
CREATE TABLE `security` (
  ...
  `covid_report` varchar(45) DEFAULT NULL,
  `ct_scan` varchar(45) DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `booking_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2021-09-03 17:30:02
