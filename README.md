...
|**airport-security-service**|<li>It is a microservice for airport officials</li><li>It is having APIs for airport SECURITY check service such as createSecurity, getSecurityById, findSecurityByBookingId</li>|
...
<br />- we build in the following sequence and make sure we have set Java Build Path of each microservice to JDK11
* eureka-server
* api-gateway
