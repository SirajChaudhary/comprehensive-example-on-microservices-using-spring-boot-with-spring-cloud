...
|**airport-checking-service**|<li>It is a microservice for airport officials</li><li>It is having APIs for airport SECURITY check service such as saveNewSecurityChecking, getSecurityById, findSecurityByBookingId</li>|
